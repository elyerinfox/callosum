...
//!
//! ```rust
//! use callosum_core::{Tensor, DType, Device};
//! # use callosum_core::Error;
...
//! - Why Callosum?
//!
//! Callosum stems from the need to reduce binary size in order to *enable serverless*
...
//! ## Other Crates
//!
//! Callosum consists of a number of crates. This crate holds core the common data structures but you may wish
