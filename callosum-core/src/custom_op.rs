...
pub struct UgIOp1 {
    ...
    #[cfg(feature = "metal")]
    func: callosum_metal_kernels::metal::ComputePipeline,
}
...
impl UgIOp1 {
    ...
    pub fn new(
        name: &'static str,
        kernel: callosum_ug::lang::ssa::Kernel,
        device: &crate::Device,
    ) -> Result<Self> {
        #[cfg(feature = "cuda")]
        {
...
impl InplaceOp1 for UgIOp1 {
    ...
    fn metal_fwd(&self, sto: &mut MetalStorage, layout: &Layout) -> Result<()> {
        ...
        let group_dims = callosum_metal_kernels::utils::get_block_dims(b, 1, 1);
        callosum_metal_kernels::utils::set_param(&encoder, 0, (sto.buffer(), 0usize));
