...
use callosum_nn::{ops::softmax_last_dim, LayerNormConfig, Module, VarBuilder};

// Geglu and feedforward from callosum-models/src/models/stable_diffusion/attention.rs
#[derive(Debug)]
struct GeGlu {
    proj: Linear,
    span: tracing::Span,
...
// CrossAttention from callosum-models/src/models/stable_diffusion/attention.rs
#[derive(Debug)]
...
impl Model {
    pub fn new(vb: VarBuilder) -> Result<Self> {
        ...
        let cross_attn_context_norm = layer_norm(
            dim,
            callosum_nn::LayerNormConfig::default(),
