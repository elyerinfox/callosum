...
impl MambaBlock {
    ...
    pub fn forward(&self, xs: &Tensor, state: &mut State) -> Result<Tensor> {
        ...
        let proj_for_conv = callosum_nn::ops::silu(&proj_for_conv)?;
        ...
        let ys = (ss * callosum_nn::ops::silu(&proj_for_silu))?;
...
impl Model {
    pub fn new(cfg: &Config, vb: VarBuilder) -> Result<Self> {
        let embedding = callosum_nn::embedding(cfg.vocab_size(), cfg.d_model, vb.pp("embedding"))?;
