...
//! - QK normalization
//!
//! - ⚡ [Interactive Wasm Example](https://huggingface.co/spaces/radames/Callosum-phi1-phi2-wasm-demo)
...
impl RotaryEmbedding {
    ...
    fn apply_rotary_emb(&self, xs: &Tensor, seqlen_offset: usize) -> Result<Tensor> {
        ...
        let xs_rot = callosum_nn::rotary_emb::rope(&xs_rot, &c, &s)?;
...
impl Attention {
    ...
    fn forward(&mut self, xs: &Tensor, mask: Option<&Tensor>) -> Result<Tensor> {
        ...
        let attn_weights =
            callosum_nn::ops::softmax_last_dim(&attn_weights)?.to_dtype(value_states.dtype())?;
