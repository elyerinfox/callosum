...
//! # Example Usage
//!
//! This callosum implementation uses a pre-trained EfficientViT (from Microsoft Research Asia) network for inference.
...
//!   --release -- \
//!   --image callosum-examples/examples/yolo-v8/assets/bike.jpg --which m1
//!
