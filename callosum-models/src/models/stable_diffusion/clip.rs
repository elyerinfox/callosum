...
impl ClipTextEmbeddings {
    fn new(vs: callosum_nn::VarBuilder, c: &Config) -> Result<Self> {
        let token_embedding =
            callosum_nn::embedding(c.vocab_size, c.embed_dim, vs.pp("token_embedding"))?;
        let position_embedding = callosum_nn::embedding(
...
impl ClipTextTransformer {
    pub fn new(vs: callosum_nn::VarBuilder, c: &Config) -> Result<Self> {
