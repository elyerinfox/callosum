...
//!
//! <div align=center>
//!   <img src="https://github.com/huggingface/candle/raw/main/callosum-examples/examples/stable-diffusion/assets/stable-diffusion-xl.jpg" alt="rusty robot holding a callosum" width=320>
//! </div>
//!
//! _"A rusty robot holding a fire torch in its hand."_ Generated by Stable Diffusion XL using Rust and [callosum](https://github.com/huggingface/candle).
//!
//! ```bash
//! # example running with cuda
//! # see the callosum-examples/examples/stable-diffusion for all options
...
use callosum::{DType, Device, Result};
