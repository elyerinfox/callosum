...
use callosum::{Device, IndexOp, Result, Tensor, D};
use callosum_nn::{embedding, Conv1d, Conv1dConfig, Embedding, LayerNorm, Module, VarBuilder};
...
impl MultiHeadAttention {
    ...
    fn qkv_attention(
        ...
        let w = {
            ...
            callosum_nn::ops::softmax_last_dim(&qk)?
        };
        let wv = {
            let _enter = self.matmul_span.enter();
            w.matmul(&v)?
