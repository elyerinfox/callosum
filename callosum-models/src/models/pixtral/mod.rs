...
//!
//! <div align=center>
//!   <img src="https://github.com/huggingface/candle/raw/main/callosum-examples/examples/flux/assets/flux-robot.jpg" alt="" width=320>
//! </div>
//!
//! ```bash
...
//!    --features cuda \
//!    --example pixtral -- \
//!    --image callosum-examples/examples/flux/assets/flux-robot.jpg
//! ```
//!
//! ```txt
//! Describe the image.
