...
//!
//! - ⚡ [Interactive Wasm Example](https://huggingface.co/spaces/lmz/callosum-llama2)
//! - 💻 llama2.c [GH Link](https://github.com/karpathy/llama2.c)
//!

use callosum::{DType, Device, IndexOp, Result, Tensor, D};
use callosum_nn::linear_no_bias as linear;
use callosum_nn::{embedding, rms_norm, Embedding, Linear, Module, RmsNorm, VarBuilder};
