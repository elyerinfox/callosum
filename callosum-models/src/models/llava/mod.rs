...
use callosum::{bail, Context, Device, IndexOp, Result, Tensor};
use callosum_nn::{seq, Activation, Module, Sequential, VarBuilder};
...
impl LLaVA {
    ...
    pub fn prepare_inputs_labels_for_multimodal(
        ...
        // can easily be replaced by nonzero if it is implemented in callosum
        ...
        // can be replace by split if it is implemented in callosum
