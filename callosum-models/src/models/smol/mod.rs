...
//!
//! ```ignore
//! use callosum_models::models::smol::smollm3::{Config, ModelForCausalLM};
//! use callosum_models::models::smol::quantized_smollm3::QuantizedModelForCausalLM;
//! use callosum::{Device, Tensor};
...
//! let vb = VarBuilder::zeros(callosum::DType::F32, &device);
