...
use callosum::{streaming, Module, Result, StreamTensor, StreamingModule, Tensor};
...
pub struct Config {
    ...
    pub final_activation: Option<callosum_nn::Activation>,
}
...
pub struct SeaNetResnetBlock {
    ...
    skip_op: callosum::StreamingBinOp,
    span: tracing::Span,
}
...
impl SeaNetResnetBlock {
    ...
    pub fn new(
        ...
        Ok(Self {
            ...
            shortcut,
            activation,
            skip_op: streaming::StreamingBinOp::new(streaming::BinOp::Add, callosum::D::Minus1),
...
impl SeaNetEncoder {
    pub fn new(cfg: &Config, vb: VarBuilder) -> Result<Self> {
        if cfg.lstm > 0 {
            callosum::bail!("seanet lstm is not supported")
        }
...
pub struct SeaNetDecoder {
    ...
    final_conv1d: StreamableConv1d,
    final_activation: Option<callosum_nn::Activation>,
    span: tracing::Span,
}
