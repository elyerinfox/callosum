...
//!
//! This callosum implementation uses a pre-trained ConvNeXt network for inference. The
...
use callosum::shape::ShapeWithOneHole;
use callosum::{Result, D};
use callosum_nn::{conv2d, layer_norm, linear, Conv2dConfig, Func, VarBuilder};
