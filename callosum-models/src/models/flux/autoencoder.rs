use callosum::{Result, Tensor, D};
use callosum_nn::{conv2d, group_norm, Conv2d, GroupNorm, VarBuilder};
...
impl callosum::Module for AttnBlock {
...
impl ResnetBlock {
    fn new(in_c: usize, out_c: usize, vb: VarBuilder) -> Result<Self> {
        let conv_cfg = callosum_nn::Conv2dConfig {
            padding: 1,
            ..Default::default()
        };
...
impl callosum::Module for ResnetBlock {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
        let h = xs
            .apply(&self.norm1)?
...
impl callosum::Module for Downsample {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl callosum::Module for Upsample {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl callosum_nn::Module for Encoder {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl callosum_nn::Module for Decoder {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl callosum_nn::Module for DiagonalGaussian {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl callosum::Module for AutoEncoder {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
