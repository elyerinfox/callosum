...
use callosum::test_utils::{to_vec0_round, to_vec2_round};

use anyhow::Result;
use callosum::{DType, Device, Tensor, Var};
use callosum_nn::{AdamW, Linear, Module, Optimizer, ParamsAdamW, SGD};
...
fn adamw_linear_regression_varmap() -> Result<()> {
    ...
    let mut var_map = callosum_nn::VarMap::new();
